...
export function SosButton() {
  ...
  const handleSosClick = async () => {
    ...
    try {
      ...
      // Send immediate SOS with location
  ...
  return (
    <>
      ...
      <button
        ...
        disabled={createRescue.isPending || initialSosSent}
        ...
        } ${createRescue.isPending ? "opacity-50 cursor-not-allowed" : ""}`}
      >
        <svg
          className="h-6 w-6"
          fill="none"
        ...
        {createRescue.isPending ? "Sending..." : initialSosSent ? "Help Sent!" : "SOS"}
      </button>
